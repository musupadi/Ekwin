package com.ascendant.ekwin.Activity.ui.Home.Pendeta;
...
public class PendetaActivity extends AppCompatActivity {
    RecyclerView rv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pendeta);
        ...
        data.enqueue(new Callback<ResponseArrayObject>() {
            ...
            public void onResponse(Call<ResponseArrayObject> call, Response<ResponseArrayObject> response) {
                try {
                    ...
                    mAdapter = new AdapterPendeta(PendetaActivity.this,mItems);
                    rv.setAdapter(mAdapter);
                    mAdapter.notifyDataSetChanged();
                }catch (Exception e){
                    Log.d("ZYARGA : ",e.toString());
                    Toast.makeText(PendetaActivity.this, "Data Kosong", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<ResponseArrayObject> call, Throwable t) {
                Toast.makeText(PendetaActivity.this, "Koneksi Gagal", Toast.LENGTH_SHORT).show();
            }
        });
    }
}